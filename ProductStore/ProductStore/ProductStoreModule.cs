    ...
    public class ProductStoreModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "2449d874-0774-4440-9bcb-238ea8d9e661");
            });
        }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<ProductStoreModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<ProductStoreModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(ProductStoreModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<ProductStoreModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<ProductStoreModule>(/* validate: true */);
        });
    }
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("ProductStore");
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.OAuthScopes("ProductStore");
        });
